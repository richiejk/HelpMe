 ...
 */
public class AddCallFirstActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addcall_1);
    ...
    protected void onResume(){
        ...
        secondaryBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(AddCallFirstActivity.this,AddCallActivity.class);
    ...
    void initUI(){
        ...
        title=(TextView)findViewById(R.id.txt_addcall_1_title);
    ...
    void fetchFromDB(){
        ...
        numbers=handler.fetchContacts(true);
